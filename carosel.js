...
const SLIDE = [
    '<article class="carosel__slide1"><div class="text"><h1>Teambuilding</h1><p>Jagtanekdoter, bramfri råvaresnak og madlavning i det fri.</p><p>Mød naturmanden Jørgen Skouboe og kokken Nikolai Kirk fra det populære tv-program “Nak og Æd”.</p><button><a href="#">Læs mere</a></button></div><img src="./asset/img/COLOURBOX2002681.jpg" alt="Snobrød"></article>','<article class="carosel__slide2"><div class="text"><h1 class="SpanHeader">Event Centrum skaber <span>den helt rigtige stemning</span></h1><div class="textSeparator"></div><p>...i jeres egne rammer (kantine, lager, parkeringskælder), udendørs (skov, strand) eller på hoteller & konferencesteder overalt i Danmark.</p><button class="buttonBorder"><a href="#">Læs mere</a></button></div><img src="./asset/img/COLOURBOX2556345.jpg" alt="Planlægningsmøde"></article>','<article class="carosel__slide3"><div class="text"><h1>Erfaring og enagagement</h1><p>Event Centrum har mange års erfaring med udvikling og afholdelse af både store og små arrangementer.</p><p>Hos Event Centrum stræber vi efter, at vores kunder kommer til at opleve glæde og motivation ved hjælp af ekstraordinære oplevelser. Vi vil med vores professionalisme og gode historier skabe grobund for at styrke relationer mellem ledelse og medarbejdere, virksomheden og kunderne.</p><button class="buttonBorder"><a href="#">Læs mere</a></button></div><img src="./asset/img/COLOURBOX548669.jpg" alt="Middelalder kriger"></article>'
];
