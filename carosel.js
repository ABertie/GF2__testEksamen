...
const SLIDE = [
    '<article class="carosel__slid"><h1>Teambuilding</h1><p>Jagtanekdoter, bramfri råvaresnak og madlavning i det fri.</p><p>Mød naturmanden Jørgen Skouboe og kokken Nikolai Kirk fra det populære tv-program “Nak og Æd”.</p><button>Læs mere</button><img src="./asset/img/COLOURBOX2002681.jpg" alt="Snobrød"></article>','<article class="carosel__slid"><h1>Event Centrum skaber<span>DEN HELT RIGTIGE STEMNING</span></h1><div class="textSeparator"></div><p>...i jeres egne rammer (kantine, lager, parkeringskælder), udendørs (skov, strand) eller på hoteller & konferencesteder overalt i Danmark.</p><button>Læs mere</button><img src="./asset/img/COLOURBOX2556345.jpg" alt="Planlægningsmøde"></article>','<article class="carosel__slid"><h1>Erfaring og enagagement</h1><p>Event Centrum har mange års erfaring med udvikling og afholdelse af både store og små arrangementer.</p><p>Hos Event Centrum stræber vi efter, at vores kunder kommer til at opleve glæde og motivation ved hjælp af ekstraordinære oplevelser. Vi vil med vores professionalisme og gode historier skabe grobund for at styrke relationer mellem ledelse og medarbejdere, virksomheden og kunderne.</p><button>Læs mere</button><img src="./asset/img/COLOURBOX548669.jpg" alt="Middelalder kriger"></article>'
];
...
window.setInterval(shuffleForward, 60000)
